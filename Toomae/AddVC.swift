...
class AddVC: UIViewController {
    ...
    var addWebSiteVC : AddWebSiteVC!
    
    var addAppVC : AddAppVC!
    
    var viewControllers : [UIViewController]!
    
    var selectedSegment = 0
    
    var mySegmentedControl = UISegmentedControl(items: ["ADD WEB SITE","ADD APP"])
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        addWebSiteVC = AddWebSiteVC(nibName: "AddWebSiteVC", bundle: nil)
        addAppVC = AddAppVC(nibName: "AddAppVC", bundle: nil)
        
        viewControllers = [addWebSiteVC,addAppVC]
